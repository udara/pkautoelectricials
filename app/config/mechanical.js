    ...
    typeOfServices: [
        {
            ...
            subServices: [
                ...
                },
                {
                    ...
                    description: 'Testing battery performance and replacing it if necessary to ensure reliable starting and electrical system function.',
                    image: 'battery_testing_replacement.png',
                    imageExtension: 'png',
                    vehicles: ['cars', 'motor bikes', 'light trucks']
                },
                {
                    name: 'Fluid Checks and Top-Ups',
                    description: 'Checking and topping up essential fluids like coolant, brake fluid, and transmission fluid to maintain optimal vehicle performance.',
                    image: 'fluid_checks_topups.png',
                    imageExtension: 'png',
                    vehicles: ['cars', 'motor bikes', 'light trucks']
                },
                {
            ...
            subServices: [
                {
                    ...
                    description: 'Performing routine maintenance as specified in your vehicle’s log book to ensure it stays in optimal condition.',
                    image: 'scheduled-maintenance.png',
                    imageExtension: 'png'
                },
                {
                    name: 'Oil and Filter Change',
                    description: 'Replacing engine oil and filters as per the log book schedule to maintain engine performance and longevity.',
                    image: 'oil-filter-change.png',
                    imageExtension: 'png'
                },
                {
                    name: 'Brake Inspection and Adjustment',
                    description: 'Inspecting and adjusting the brakes according to manufacturer guidelines to ensure safety and performance.',
                    image: 'brake-inspection-adjustment.png',
                    imageExtension: 'png'
                },
                {
                    name: 'Fluid Level Checks and Top-Ups',
                    description: 'Checking and topping up all essential fluids, including coolant, brake fluid, and transmission fluid, to ensure proper vehicle operation.',
                    image: 'fluid-level-checks.png',
                    imageExtension: 'png'
                },
                {
                    name: 'Battery Check',
                    description: 'Inspecting the battery’s condition and terminals, and testing its performance to ensure reliable starting and electrical function.',
                    image: 'battery-check.png',
                    imageExtension: 'png'
                },
                {
                    name: 'Tyre Rotation and Pressure Check',
                    description: 'Rotating tyres and checking pressure as recommended to extend tyre life and ensure even wear.',
                    image: 'tyre-rotation-pressure-check.png',
                    imageExtension: 'png'
                },
                {
                    name: 'Air Filter Replacement',
                ...
                },
                {
                    ...
                    description: 'Inspecting and adjusting or replacing drive belts as needed to prevent breakdowns and ensure smooth operation of engine accessories.',
                    image: 'drive-belt-inspection.png',
                    imageExtension: 'png'
                }
            ],
        ...
        },
        {
            ...
            subServices: [
                ...
                },
                {
                    ...
                    description: 'Inspecting and servicing the brake calipers, which apply pressure to the brake pads, including cleaning, lubricating, or replacing the calipers if necessary.',
                    image: 'brake-caliper-service.png',
                    imageExtension: 'png'
                },
                {
                    name: 'Brake Line Inspection and Repair',
                    description: 'Checking the brake lines for leaks, cracks, or corrosion and repairing or replacing them to ensure there are no issues with fluid pressure.',
                    image: 'brake-line-inspection-and-repair.png',
                    imageExtension: 'png'
                },
                {
