    ...
    return (
        <div className={`mx-auto w-full px-6 py-10 md:py-15 lg:items-center max-w-screen-xl min-h-[calc(100vh-111px)]`}>
            ...
            <div
                ...
                <IconListBoxWithLink text={`Specialty Services`} link={`services/specialty-services`} image={`/images/special.png`} />
                <IconListBoxWithLink text={`Accessory Fitting`} link={`services/vehicle-accessory-fitter`} image={`/images/accessoryFitting.png`} />
                <IconListBoxWithLink text={`Battery Replacement`} link={`services/battery`} image={`/images/battery.png`} />
            </div>
        </div>
    );
};
